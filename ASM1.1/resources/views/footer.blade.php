<footer class="footer_style_2">
  <div class="container-fuild">
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <ul class="footer-menu">
              ...
              <li><a href="it_term_condition.html"><i class="fa fa-angle-right"></i> Điều khoản và điều kiện</a></li>
              <li><a href="it_privacy_policy.html"><i class="fa fa-angle-right"></i> Chính sách bảo mật</a></li>
              <li><a href="it_news.html"><i class="fa fa-angle-right"></i> Tin tức</a></li>
              <li><a href="it_contact.html"><i class="fa fa-angle-right"></i> Liên hệ chúng tôi</a></li>
            </ul>
          </div>
          <div class="col-md-6">
            <div class="main-heading left_text">
          ...
          <div class="col-md-6">
            ...
            <p>123 Đường Hai, Phố Fifth Avenue,<br>
      ...
      <div class="cprt">
        <p>ItNext © Bản quyền 2019 Thiết kế bởi html.design</p>
      </div>
    </div>
  </div>
</footer>
