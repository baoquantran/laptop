...
<h4 class="btm-sep pb-3 mb-5">Quên mật khẩu</h4>
<form class="form" method="post" action="{{route('quenmkpost')}}"> @csrf
...
<button type="submit" id="submit" class="btn btn-lg btn-custom btn-dark btn-block">Xác nhận</button>
</div>
</div>
</form>
</div>
