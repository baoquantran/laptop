          ...
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              ...
              <ol class="breadcrumb">
                ...
                <li class="active">{{$listtype[0]->ten_loai}}</li>
              </ol>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9">
          ...
          @foreach($listtype as $lt)
            <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_30_all">
              <div class="product_list">
                <div class="product_img"> <img class="img-responsive" src='{{$lt->hinh}}' alt=""> </div>
                <div class="product_detail_btm">
                  <div class="center">
                    <h4><a href="{{url('detail',[$lt->id_sp,$lt->id_loai])}}">{{$lt->ten_sp}}</a></h4>
                  </div>
                  <div class="center">
                    <h6><a href="">{{$lt->ten_loai}}</a></h6>
                  </div>
                  <div class="starratin">
                    <div class="center"> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star-o" aria-hidden="true"></i> </div>
                  </div>
                  <div class="product_price">
                    <p><span class="old_price">{{ number_format( $lt->gia_km , 0 , "," , ".") }}</span> – <span class="new_price">{{ number_format( $lt->gia , 0 , "," , ".") }}</span></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <center><div class="p-2">{{ $listtype->onEachSide(1)->links() }}</div></center>
      </div>
