...
<form class="form" method="post" action="{{url('/dangnhap')}}"> @csrf
@if(Session::exists('thongbao'))
<h5 class="alert alert-info text-center"> {{ Session::get('thongbao') }} </h5>
@endif
<div class="row">
<div class="col-12">
<input type="text" hidden value="vaitro" name="vaitro">
<div class="form-group position-relative">
<span class="zmdi zmdi-account"></span>
<input name="email" type="email" id="email" class="form-control" placeholder="Địa chỉ Email">
</div>
</div>
<div class="col-12">
<div class="form-group position-relative">
<span class="zmdi zmdi-email"></span>
<input name="matkhau" type="password" id="password" class="form-control" placeholder="Mật khẩu">
</div>
</div>
...
<button type="submit" id="submit" class="btn btn-lg btn-custom btn-dark btn-block">Đăng nhập
</button>
</div>
</div>
</form>
...
<a href="/dangky" class="btn btn-custom">Đăng ký</a>
</div>
