...
<form  method="post" action="{{route('user.update',$user->id_user)}}" > @csrf
@method('PUT')
                                            ...
                                            <div class="col-lg-">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input name="ho" type="text" class="form-control" value="{{$user->ho}}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input name="ten" type="text" class="form-control" value="{{$user->ten}}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input name="dienthoai" type="number" class="form-control" value="{{$user->dienthoai}}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
