                ...
                <div class="review-tab-pro-inner">
                    ...
                    <div id="myTabContent" class="tab-content custom-product-edit">
                        <div class="product-tab-list tab-pane fade active in" id="description">
                            <div class="row ">
                               <form action="{{route('loai.update', $loai->id_loai)}}" method="post">
                                <div class=""> @csrf @method('PUT')
                                    <div class="review-content-section">
                                        ...
                                        <div class="input-group mg-b-pro-edt">
                                            ...
                                            <input type="text" name="thutu" class="form-control" value="{{$loai->thutu}}">
                                        </div>
                                     
                                       
                                        <div class='input-group mg-b-pro-edt'> 
                                            <label class="text-warning"> Ẩn hiện</label> 
                                            <input name="anhien" type="radio" value="0" {{ $loai->anhien==0? "checked":"" }}><b class="text-warning"> Ẩn</b>
                                            <input name="anhien" type="radio" value="1" {{ $loai->anhien==1? "checked":"" }}> <b class="text-warning">Hiện</b>
                                            </div>
                                        </div>
                                </div>
