                                ...
                                <div class=""> @csrf
                                    <div class="review-content-section">
                                        <div class="input-group mg-b-pro-edt">
                                            ...
                                            <input type="text" name="ten_loai" class="form-control" placeholder="Tên loại">
                                        </div>
                                        <div class="input-group mg-b-pro-edt">
                                        ...
                                        <div class='input-group mg-b-pro-edt'> 
                                            ...
                                            <input name="anhien" type="radio" value="0"><b class="text-warning"> Ẩn</b>
                                            <input name="anhien" type="radio" value="1" checked> <b class="text-warning">Hiện</b>
                                            </div>
                                        </div>
                                </div>
                                <div class="row">
